    ...
    <>
      ...
      <div className={cn(
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          {/* Outlook sync — only shown for users linked to a staff member */}
            ...
            <div className="px-5 py-4 border-b border-border">
              ...
              {outlook.connected ? (
                ...
                <button
                  ...
                  className="flex items-center gap-3 w-full rounded-xl border-2 border-dashed border-primary/30 px-4 py-3.5 hover:bg-primary/5 hover:border-primary/60 active:scale-[0.98] transition-all duration-200 ease-out cursor-pointer group"
                >
                  ...
                  <div className="text-left">
                    <p className="text-[13px] font-medium text-foreground">{to("connectOutlook")}</p>
