...
import { CalendarDays, ClipboardList, ArrowLeftRight, Banknote } from "lucide-react"
...
function UnpaidLeaveReportView({ data, onBack }: { data: UnpaidLeaveReportData; onBack: () => void }) {
  const t = useTranslations("reports")
