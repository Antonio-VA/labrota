...
const TAB_KEYS = ["configuracion", "usuarios", "estadisticas", "funcionalidades", "facturacion", "rrhh", "implementacion", "backups"] as const
...
export function AdminOrgTabs({
  estadisticas, configuracion, usuarios, funcionalidades, facturacion, rrhh, implementacion, backups,
}: {
  ...
  const content: Record<TabKey, React.ReactNode> = { estadisticas, configuracion, usuarios, funcionalidades, facturacion, rrhh, implementacion, backups }
