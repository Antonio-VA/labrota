    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-background rounded-xl border border-border shadow-xl w-[420px] flex flex-col">
        ...
        <div className="px-5 py-4 flex flex-col gap-3">
          <div>
            <label className="text-[12px] text-muted-foreground font-medium mb-1 block">{t("subject")}</label>
            <Input
              value={subject}
          ...
          <div>
            <label className="text-[12px] text-muted-foreground font-medium mb-1 block">{t("message")}</label>
            <textarea
              value={message}
        ...
        <div className="px-5 py-3 border-t border-border flex justify-end gap-2">
          <Button variant="ghost" size="sm" onClick={onClose} disabled={isPending}>{tc("cancel")}</Button>
