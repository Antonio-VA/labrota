...
const content = {
  en: {
    ...
    how: {
      ...
      steps: [
        { title: "Configure your lab", body: "Add your staff, their competencies (embryologist, andrologist, senior, junior), certifications and availability preferences." },
        { title: "Generate with AI", body: "Ask LabRota to build the rota — it balances workload, ensures HFEA coverage, respects leave and avoids skill gaps automatically." },
        { title: "Review & adjust", body: "Drag and drop to make tweaks. LabRota flags any compliance issues in real time as you edit." },
      ...
      stat2: { value: "100%", label: "HFEA compliant", sub: "every rota, always" },
  ...
  es: {
    ...
    how: {
      ...
      steps: [
        { title: "Configura tu laboratorio", body: "Añade tu equipo, sus competencias (embriólogo, andrólogo, senior, junior), certificaciones y preferencias de disponibilidad." },
        { title: "Genera con IA", body: "Pide a LabRota que construya la rota — equilibra la carga, asegura la cobertura HFEA, respeta las ausencias y evita los skill gaps automáticamente." },
        { title: "Revisa y ajusta", body: "Arrastra y suelta para hacer ajustes. LabRota señala cualquier incumplimiento en tiempo real mientras editas." },
      ...
      stat2: { value: "100%", label: "HFEA conforme", sub: "cada rota, siempre" },
