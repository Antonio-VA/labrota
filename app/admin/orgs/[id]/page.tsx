...
export default async function OrgDetailPage({
  ...
  const [
    ...
    admin.from("lab_config").select("country, region, enable_leave_requests, enable_swap_requests, enable_outlook_sync, enable_notes, annual_leave_days, default_days_per_week, public_holiday_reduce_budget").eq("organisation_id", id).maybeSingle(),
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          <AdminOrgHeaderActions org={org} hrActive={hrStatus.active} activeModule="labrota" />
        </div>
      </div>
      ...
      <AdminOrgTabs
        ...
        funcionalidades={
          <AdminOrgDetailClient
            ...
            initialEnableOutlookSync={(labConfigRes.data as { enable_outlook_sync?: boolean } | null)?.enable_outlook_sync ?? false}
