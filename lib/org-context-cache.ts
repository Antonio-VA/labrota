...
export interface OrgContext {
  ...
  staff: { id: string; first_name: string; last_name: string; role: string; onboarding_status: string; contract_type: string | null; onboarding_end_date: string | null }[]
    ...
    async (): Promise<OrgContext> => {
      ...
      const [
        ...
        admin.from("organisations")
          ...
          .maybeSingle(),
        admin.from("staff")
          .select("id, first_name, last_name, role, onboarding_status, contract_type, onboarding_end_date")
          .eq("organisation_id", orgId),
      ...
      return {
        ...
        staff: (staffRes.data ?? []) as { id: string; first_name: string; last_name: string; role: string; onboarding_status: string; contract_type: string | null; onboarding_end_date: string | null }[],
